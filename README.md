...
Week Front News Report 是一个智能化的中文前端技术周刊聚合工具，基于 AI Agent + Agent Skills + MCP 架构，从预设的数据源链接中抓取内容，筛选生成每周 Markdown 报告。
...
在支持 Agent Skils 并配置好 Chrome DevTools MCP 的 AI 编辑器或终端工具中输入如下提示词：
